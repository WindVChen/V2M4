...
def run_full(image: str, rmbg_img=None, rmbg_net=None, triposg_pipe=None, mv_adapter_pipe=None, align_scale_with_Trellis=False, seed=0, texture_pipe=None, mod_config=None):
