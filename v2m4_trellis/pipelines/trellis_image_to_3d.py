...
class TrellisImageTo3DPipeline(Pipeline):
    ...
    def preprocess_image(input: Image.Image, return_rgba=False, return_all_rbga=False) -> Image.Image:
        ...
        # If the crop is out of the image, it will be automatically padded with black.
    ...
    def sample_slat(
        ...
        Args:
            ...
            sampler_params (dict): Additional parameters for the sampler.
            optimize_uncond_noise (dict): Additional parameters for optimizing negative tensor.
        """
        ...
        if optimize_uncond_noise != {}:
            slat = self.slat_sampler.gradient_sample(
                flow_model,
                noise,
                **cond,
                **sampler_params,
                verbose=True,
                optimize_uncond_noise=optimize_uncond_noise,
            ).samples
        else:
    ...
    def run(
        ...
        return before_crop, self.decode_slat(slat, formats), slat, coords, cond
